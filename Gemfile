...
group :test, :development, :staging do
  gem 'jellyfish-demo', github: 'projectjellyfish/jellyfish-demo', branch: 'demo/jellyfish-miq'
  gem 'jellyfish-miq', github: 'projectjellyfish/jellyfish-miq', branch: 'demo/jellyfish-miq'
